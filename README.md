...
* Apply Business Intelligence concepts to data visualization.
* Build an interactive dashboard using only native web technologies.
* Maintain a modular and scalable architecture.
* Provide a solid foundation for future project enhancements.
...
The project follows a modular front-end architecture that separates responsibilities into independent components.

## Organization

* `index.html` contains the application structure.
* `css/` stores the project's style sheets.
* `js/` contains modular JavaScript files.
* `data/` stores the JSON dataset.
...
The current release establishes a solid foundation for future development.
...
Future versions should preserve the project's modular architecture while extending its analytical capabilities.
